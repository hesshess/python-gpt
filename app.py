...
@st.cache_resource(show_spinner="Embedding filesssssssss...")
def embed_file(file):
    ...
    embeddings = OpenAIEmbeddings(api_key=st.session_state.key)
...
if key:
    ...
    with st.sidebar:
        file = st.file_uploader(
            "Upload a .txt .pdf or .dcx file", type=["pdf", "txt", "docs"]
        )
...
st.sidebar.link_button(
    "🏠 Github repository 🏠",
    "https://github.com/hesshess/python-gpt/blob/2ce8a041c306af8404c893aa8037f15e8681589c/app.py",
)
