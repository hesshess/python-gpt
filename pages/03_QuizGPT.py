...
questions_prompt = ChatPromptTemplate.from_messages([
        ...
        Each question should have 4 answers, three of them must be incorrect and one should ne correct.
...
if not docs:
    st.markdown(
        ...
        I will make a quiz from Wikipedia articles or files you upload to test your knowlege and  help you study.
        
        Get started my uploading a file or searching on Wikipedia in the sidebar.
        """
    )         
else:
